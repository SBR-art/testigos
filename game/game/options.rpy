...
define config.save_directory = "DOBLECLASE-1764184838"
...
# ESTO DEFINE CÓMO SE VE EL TEXTO
style titulo_transicion:
    font "letratitulos.ttf"  # <--- AQUÍ PON EL NOMBRE EXACTO DE TU ARCHIVO
    size 80
    color "#ffffff"
    outlines [ (2, "#000000") ]
    xalign 0.5
