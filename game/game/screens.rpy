...
screen say(who, what):
    ...
    if not renpy.get_screen("phone_menu"):
...
screen navigation():
    vbox:
        ...
        # 1.0 lo pega al borde derecho
        xpos 1.0
        yalign 0.5

        # 1.0 le dice: "Tu punto de agarre es tu lado derecho"
        # Esto hace que el texto crezca hacia la IZQUIERDA (hacia adentro)
        xanchor 1.0

        # Margen para que no toque el borde físico del monitor
        xoffset -50 
...
screen game_menu(title, scroll=None, yinitial=0.0, spacing=0):
    ...
    if main_menu:
        ...
        add "images/Fondos/cargar.png"

    elif title == _("Configuración"):
        add "images/Fondos/configuracion.png"

    elif title == _("Acerca de"):
        add "images/Fondos/acercade.png"

    elif title == _("Ayuda"):
        add "images/Fondos/ayuda.png"
...
screen morning_transition(mensaje):
    tag morning_transition
    layer "master" 
    
    add "#000" # Esto pone el fondo negro
    
    text mensaje:
        style "titulo_transicion" # <--- Aquí le decimos: "Usa la ropa que definimos antes"
        at transform:
            alpha 0.0
